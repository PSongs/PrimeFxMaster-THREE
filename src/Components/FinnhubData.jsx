...
const CoinGeckoDayMovers = () => {
  ...
  return (
    <div className='flex justify-between p-5 gap-7 sm:p-2 sm:gap-3 md:p-5 md:gap-7 lg:p-5 lg:gap-7 xl:p-5 xl:gap-7 2xl:p-5 2xl:gap-7 bg-white mt-5 w-full rounded-[30px]'>
      <div className='w-1/2'>
        ...
        {gainers ? (
          <ul className='space-y-4'>
            {gainers.map((coin) => (
              <li key={coin.id} className='flex items-center space-x-4 bg-gray-100 p-4 rounded-lg flex-col sm:flex-row justify-between pt-5 px-3 sm:px-5 h-[300px] xl:h-[100%] 2xl:h-[100%] text-xs'>
