...
const DashBoard = () => {
  ...
  return (
    <div className='w-full px-4 sm:px-5 lg:px-10 xl:px-24 h-[100%]'>
    <Frame>
      <div className='w-full p-4 lg:p-6 xl:p-8 h-[485vh] lg:h-[300vh] xl:h-[280vh] 2xl:h-[280vh] '>
        <div className='w-full h-[690px] xl:h-[310px] 2xl:h-[310px] bg-white rounded-3xl p-2 sm:p-4'>
          ...
          <div className='bg-gray-100 h-[370px] mt-6 w-full rounded-xl'>
            <div className='bg-[whitesmoke] w-full pr-4 pl-4 pt-7 pb-7 h-[140%] xl:h-[70%] 2xl:h-[70%] rounded-xl'>
              ...
              <div className='p-4'>
                ...
                <div className='p-5'>
                  <div className='flex flex-col sm:flex-row gap-2 border-b-gray-400 border-b'>
                    <li
